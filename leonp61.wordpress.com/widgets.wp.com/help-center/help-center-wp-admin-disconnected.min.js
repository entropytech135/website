(() => {
    var e = {
            46: e => {
                ...
                Object.defineProperty(o, "defaultMaxListeners", {
                    ...
                    if ("function" == typeof c) r(c, this, t);
                        ...
                        for (var u = c.length, l = p(c, u), n = 0; n < u; ++n) r(l[n], this, t);
                    return !0
            ...
            90: (e, t, n) => {
                ...
                })(), t.colors = ["#0000CC", "#0000FF", "#0033CC", "#0033FF", "#0066CC", "#0066FF", "#0099CC", "#0099FF", "#00CC00", "#00CC33", "#00CC66", "#00CC99", "#00CCCC", "#00CCFF", "#3300CC", "#3300FF", "#3333CC", "#3333FF", "#3366CC", "#3366FF", "#3399CC", "#3399FF", "#33CC00", "#33CC33", "#33CC66", "#33CC99", "#33CCCC", "#33CCFF", "#6600CC", "#6600FF", "#6633CC", "#6633FF", "#66CC00", "#66CC33", "#9900CC", "#9900FF", "#9933CC", "#9933FF", "#99CC00", "#99CC33", "#CC0000", "#CC0033", "#CC0066", "#CC0099", "#CC00CC", "#CC00FF", "#CC3300", "#CC3333", "#CC3366", "#CC3399", "#CC33CC", "#CC33FF", "#CC6600", "#CC6633", "#CC9900", "#CC9933", "#CCCC00", "#CCCC33", "#FF0000", "#FF0033", "#FF0066", "#FF0099", "#FF00CC", "#FF00FF", "#FF3300", "#FF3333", "#FF3366", "#FF3399", "#FF33CC", "#FF33FF", "#FF6600", "#FF6633", "#FF9900", "#FF9933", "#FFCC00", "#FFCC33"], t.log = console.debug || console.log || (() => {}), e.exports = n(869)(t);
                let {
                    formatters: r
                } = e.exports;
                r.j = function(e) {
                    ...
                    let s = t ? a : c,
                        {
                            ok: l,
                            buckets: f
                        } = u(e.sensitive_pixel_options, e.sensitive_pixel_option, s);
                    return n ? {
                        ok: l,
                        buckets: { ...c.buckets,
            ...
            250: e => {
                ...
                e.exports = function(e, n) {
                    ...
                    if ("number" === a && isFinite(e)) {
                        return n.long ? (i = Math.abs(r = e)) >= 864e5 ? t(r, i, 864e5, "day") : i >= 36e5 ? t(r, i, 36e5, "hour") : i >= 6e4 ? t(r, i, 6e4, "minute") : i >= 1e3 ? t(r, i, 1e3, "second") : r + " ms" : (s = Math.abs(o = e)) >= 864e5 ? Math.round(o / 864e5) + "d" : s >= 36e5 ? Math.round(o / 36e5) + "h" : s >= 6e4 ? Math.round(o / 6e4) + "m" : s >= 1e3 ? Math.round(o / 1e3) + "s" : o + "ms"
                    }
            ...
            284: (e, t) => {
                ...
                t.parse = function(e, t) {
                    ...
                    if (r.expires) {
                        var h, d = r.expires;
                        if (h = d, "[object Date]" !== n.call(h) || isNaN(d.valueOf())) throw TypeError("option expires is invalid");
            ...
            342: (e, t, n) => {
                ...
                n(595);
                var c = n(189);
                let u = ["calypso", "jetpack", "remotedatablocks", "wpcom_dsp_widget"],
                    l = ["a8c_cookie_banner_ok", "a8c_cookie_banner_view", "a8c_ccpa_optout", "wcadmin_storeprofiler_payment_login", "wcadmin_storeprofiler_payment_create_account", "calypso_checkout_switch_to_p_24", "calypso_checkout_composite_p24_submit_clicked", "wpcom_launchbar_button_click", "wpcom_support_free_migration_request_click"],
                    f = Promise.resolve();
                "undefined" != typeof document && (0, o.k0)("//stats.wp.com/w.js?67");
                let h = new i.EventEmitter;

                function d(e, t) {
                    var n, i;
                    t = t || {};
                    let o = (0, s.H)();
                    o ? .localeSlug && (t.user_lang = o.localeSlug);
                    let f = (0, c.Ay)();
                    if (!f ? .buckets.analytics) return void(0, a.A)('Analytics has been disabled - Ignoring event "%s" with actual props %o', e, t);
                    if ((0, a.A)('Record event "%s" called with props %o', e, t), n = e, !u.some(e => n.startsWith(`${e}_`)) && !l.includes(e)) return void(0, a.A)("- Event name must be prefixed by a known source or added to `EVENT_NAME_EXCEPTIONS`");
                    if (r) {
                        let e = r(t);
                        t = { ...t,
                            ...e
                    ...
                    t = Object.fromEntries(Object.entries(t).filter(([, e]) => void 0 !== e)), (0, a.A)('Recording event "%s" with actual props %o', e, t), i = ["recordEvent", e, t], window._tkq = window._tkq || [], window._tkq.push(i), h.emit("record-event", e, t)
                }
            },
            371: (e, t, n) => {
                "use strict";
            ...
            391: () => {
                let e = "undefined" != typeof helpCenterData && helpCenterData ? .isProxied;
                window.configData = {
                    env_id: e ? "staging" : "production",
                    features: {
                        "help/gpt-response": !0
                    },
                    wapuu: !1
            ...
            461: (e, t, n) => {
                ...
                t.inherits = n(615), t.toArray = function(e, t) {
                    ...
                    return n
                }, t.zero2 = o, t.zero8 = s, t.join32 = function(e, t, n, i) {
                    var o, s = n - t;
                    r(s % 4 == 0);
                    ...
                    var c, u = t;
                    return e + n + i + s + (c = 0 + +((u = u + r >>> 0) < t) + +((u = u + o >>> 0) < o) + +((u = u + a >>> 0) < a)) >>> 0
                }, t.sum64_4_lo = function(e, t, n, r, i, o, s, a) {
                    return t + r + o + a >>> 0
                }, t.sum64_5_hi = function(e, t, n, r, i, o, s, a, c, u) {
                    var l, f = t;
                    return e + n + i + s + c + (l = 0 + +((f = f + r >>> 0) < t) + +((f = f + o >>> 0) < o) + +((f = f + a >>> 0) < a) + +((f = f + u >>> 0) < u)) >>> 0
            ...
            536: (e, t, n) => {
                ...
                var r = n(461),
                    ...
                    g = o.g1_256,
                    v = i.BlockHash,
                    m = [0x428a2f98, 0x71374491, 0xb5c0fbcf, 0xe9b5dba5, 0x3956c25b, 0x59f111f1, 0x923f82a4, 0xab1c5ed5, 0xd807aa98, 0x12835b01, 0x243185be, 0x550c7dc3, 0x72be5d74, 0x80deb1fe, 0x9bdc06a7, 0xc19bf174, 0xe49b69c1, 0xefbe4786, 0xfc19dc6, 0x240ca1cc, 0x2de92c6f, 0x4a7484aa, 0x5cb0a9dc, 0x76f988da, 0x983e5152, 0xa831c66d, 0xb00327c8, 0xbf597fc7, 0xc6e00bf3, 0xd5a79147, 0x6ca6351, 0x14292967, 0x27b70a85, 0x2e1b2138, 0x4d2c6dfc, 0x53380d13, 0x650a7354, 0x766a0abb, 0x81c2c92e, 0x92722c85, 0xa2bfe8a1, 0xa81a664b, 0xc24b8b70, 0xc76c51a3, 0xd192e819, 0xd6990624, 0xf40e3585, 0x106aa070, 0x19a4c116, 0x1e376c08, 0x2748774c, 0x34b0bcb5, 0x391c0cb3, 0x4ed8aa4a, 0x5b9cca4f, 0x682e6ff3, 0x748f82ee, 0x78a5636f, 0x84c87814, 0x8cc70208, 0x90befffa, 0xa4506ceb, 0xbef9a3f7, 0xc67178f2];

                function y() {
                    if (!(this instanceof y)) return new y;
                    v.call(this), this.h = [0x6a09e667, 0xbb67ae85, 0x3c6ef372, 0xa54ff53a, 0x510e527f, 0x9b05688c, 0x1f83d9ab, 0x5be0cd19], this.k = m, this.W = Array(64)
                }
                r.inherits(y, v), e.exports = y, y.blockSize = 512, y.outSize = 256, y.hmacStrength = 192, y.padLength = 64, y.prototype._update = function(e, t) {
                    ...
                    for (s(this.k.length === n.length), r = 0; r < n.length; r++) {
                        var x = u(_, d(y), l(y, b, C), this.k[r], n[r]),
                            w = a(h(i), f(i, o, v));
                        _ = C, C = b, b = y, y = a(m, x), m = v, v = o, o = i, i = a(x, w)
                    }
                    this.h[0] = a(this.h[0], i), this.h[1] = a(this.h[1], o), this.h[2] = a(this.h[2], v), this.h[3] = a(this.h[3], m), this.h[4] = a(this.h[4], y), this.h[5] = a(this.h[5], b), this.h[6] = a(this.h[6], C), this.h[7] = a(this.h[7], _)
            ...
            600: (e, t, n) => {
                ...
                t.ft_1 = function(e, t, n, r) {
                    var o;
                    return 0 === e ? (o = t) & n ^ ~o & r : 1 === e || 3 === e ? t ^ n ^ r : 2 === e ? i(t, n, r) : void 0
            ...
            772: (e, t, n) => {
                ...
                var r = n(90);
                let i = n.n(r)()("lib/load-script/callback-handler"),
                    o = new Map;
                ...
                function a(e, t) {
                    s(e) ? (i(`Adding a callback for an existing script from "${e}"`), o.get(e).add(t)) : (i(`Adding a callback for a new script from "${e}"`), o.set(e, new Set([t])))
                }

                function c(e, t = null) {
                    let n = o.get(e);
                    n && (i(`Executing callbacks for "${e}"` + (null === t ? " with success" : ` with error "${t}"`)), n.forEach(e => {
                ...
                function u() {
                    ...
                    i(`Handling successful request for "${e}"`), c(e), this.onload = null
                }

                function l() {
                    let e = this.getAttribute("src");
                    i(`Handling failed request for "${e}"`), c(e, Error(`Failed to load script "${e}"`)), this.onerror = null
                }
            },
            784: e => {
                function t(e, t) {
                ...
                e.exports = function(e) {
                    ...
                    function i(e, t) {
                        let n = 0,
                            ...
                            o = 0;
                        for (; n < e.length;)
                            if (r < t.length && (t[r] === e[n] || "*" === t[r])) "*" === t[r] ? (i = r, o = n) : n++, r++;
                            else {
                                if (-1 === i) return !1;
                                r = i + 1, n = ++o
                            }
                    ...
                    return t.debug = t, t.default = t, t.coerce = function(e) {
                        ...
                        for (let n of (t.save(e), t.namespaces = e, t.names = [], t.skips = [], ("string" == typeof e ? e : "").trim().replace(/\s+/g, ",").split(",").filter(Boolean))) "-" === n[0] ? t.skips.push(n.slice(1)) : t.names.push(n)
                    }, t.enabled = function(e) {
                        for (let n of t.skips)
                            if (i(e, n)) return !1;
                        for (let n of t.names)
                            if (i(e, n)) return !0;
                        return !1
                    }, t.humanize = n(250), t.destroy = function() {
            ...
            944: (e, t, n) => {
                ...
                function a(e, t, n) {
                    return ((0, o.VP)(e) || (0, s.H)((0, s.u)(e, n)), "function" == typeof t) ? void(0, o.Ko)(e, t) : new Promise((t, n) => {
                        (0, o.Ko)(e, e => {
                            null === e ? t() : n(e)
                        })
                    })
            ...
            948: (e, t, n) => {
                ...
                n.d(t, {
                    Oy: () => r.Oy
                }), n(595), n(379), n(910), n(189), n(121), n(472), n(750), n(739);
                var r = n(342);
                n(67)
            }
        },
    ...
    (() => {
        ...
        function t() {
            let t = document.getElementById("wp-admin-bar-help-center");
            t && !t.dataset.trackingInitialized && (t.addEventListener("click", () => {
                (0, e.Oy)("calypso_inlinehelp_show", {
                    force_site_id: !0,
                    location: "help-center",
                    section: "wp-admin",
                    jetpack_disconnected_site: !0
                })
            }), t.dataset.trackingInitialized = "true")
        }
        n(274), "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", t) : t()
    })(), window.helpCenter = r
})();